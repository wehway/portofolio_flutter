...
import 'package:top_train/ui/widgets/custom_text_form_field.dart';
...
class SignUpPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget inputSection() {
      ...
      Widget emailInput() {
        return CustomTextFormField(title: 'Email Address', hintText: 'Your email address');
      }
      ...
      Widget hobbyInput() {
        return CustomTextFormField(title: 'Hobby', hintText: 'Enter your hobby');
      }
